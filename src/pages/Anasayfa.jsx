...
const Anasayfa = () => {
  ...
  const importantDates = [
    ...
    { event: "Bildiri Gönderimi Son Günü", date: <><span className="line-through text-gray-400">27 Ocak 2026</span><br /><span className="text-red-600">8 Şubat 2026</span></>, status: "upcoming" },
