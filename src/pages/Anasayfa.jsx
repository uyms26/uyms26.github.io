...
const Anasayfa = () => {
  ...
  <div className="bg-cover bg-center bg-no-repeat min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[700px] xl:min-h-[970px]" style={{ backgroundImage: `url(${LandingHero})` }}>
