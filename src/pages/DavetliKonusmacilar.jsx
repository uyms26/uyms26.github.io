                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
                        ...
                        <div className="space-y-6 text-gray-700 leading-relaxed text-md">
                            <p>
                                Günümüz dijital çözümleri artık yalnızca bağımsız yazılım ürünleri olarak ele alınamaz. Yazılım, yapay zekâ, veri, donanım, insan, organizasyonel yapılar ve düzenleyici gereksinimler giderek daha fazla iç içe geçmekte; ortaya karmaşık, bağlantılı ve yazılım ağırlıklı akıllı sistemler çıkmaktadır. Bu dönüşüm, yazılım mühendisliğinin karşı karşıya olduğu problemleri de değiştirmektedir. Kırılgan mimariler, entegrasyon zorlukları, uzun vadeli evrim, yaşam döngüsü yönetimi, yönetişim ve uyumluluk gereksinimleri artık yalnızca yazılım düzeyinde çözülebilecek teknik problemler değildir. Bunlar daha geniş anlamda sistem problemleridir.
</p>
                            <p>
                                Bu konuşmada, yazılım mühendisliğinin geleneksel sınırları eleştirel bir bakışla değerlendirilecek ve karmaşık dijital sistemlerin geliştirilmesinde sistem düşüncesinin ve sistem mühendisliği ilkelerinin neden giderek daha önemli hale geldiği tartışılacaktır. Bununla birlikte dönüşüm tek yönlü değildir. Yazılım, veri ve yapay zekânın sistemlerin merkezine yerleşmesi, sistem mühendisliğinin kendisinin de yeniden düşünülmesini gerektirmektedir. Yazılım mühendisliği artık sistem düzeyinde ele alınması gereken bir alana dönüşürken, sistem mühendisliği de yazılımın, verinin ve yapay zekânın belirleyici hale geldiği yeni mühendislik gerçekliği içinde kendisini yenilemek zorundadır.
</p>
                            <p>
                                Konuşmanın son bölümünde, yazılım ve sistem mühendisliği eğitimlerinin bu yeni gerçekliğe nasıl uyum sağlayabileceği ele alınacaktır. Özellikle yazılım ağırlıklı akıllı sistemler geliştirebilen, sistem düşüncesi yetkinliklerine sahip mühendisler yetiştirmenin stratejik önemi vurgulanacaktır. Türkiye bağlamı üzerinden yazılım mühendisliği ve sistem mühendisliği eğitimi ile araştırmasındaki mevcut boşluklar, fırsatlar ve olası gelişim yönleri tartışılacaktır.</p>
                        </div>
                    </div>
                </div>
            </div>
